package com.inti.formation.price;

import com.inti.formation.price.data.Price;
import com.inti.formation.price.serillizer.JsonPriceSeriallizer;
...
public class AppPriceProducer {
    ...
    public static void main(String[] args) {
        SpringApplication.run(AppPriceProducer.class, args);
    }
    ...
    public Map<String, Object> producerConfigs() {
        ...
        conf.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JsonPriceSeriallizer.class.getName());
